    ...
    if (ValidarCampos()) {
        ...
        $.ajax({
            ...
            if (data.codigo === "Error") {
                ...
                $("#divListaPuesto").html('<h4 class="card-title" style="text-align:center">Sin resultados para mostrar</h4>');
                Ocultar();
            }
...
function ValidarCampos() {
    ...
    if (!Valido) {
        swal({
            title: 'Informaci\u00f3n',
            text: 'Es obligatorio capturar Puesto',
            icon: 'warning',
...
function Buscar() {
    ...
    $.ajax({
        ...
        if (data.codigo === "Error") {
            ...
            $("#divListaPuesto").html(data.ListaCat);
            $('#tblPuesto').DataTable({
                //responsive: false,
                searching: true,
                ordering: true,
                ...
                scrollY: true,
                "language": {
                    "lengthMenu": "Mostrar _MENU_ Puestos",
                    "zeroRecords": "Ningun Puesto Encontrado - valide su busqueda",
                    "info": "Mostrando página _PAGE_ de _PAGES_",
                    "infoEmpty": "No hay Puestos disponible",
                    "infoFiltered": "(filtrado de _MAX_ Puestos en total)",
                    "search": "Buscar:",
                    "paginate": {
                        "next": "Siguiente",
                        "previous": "Anterior"
...
function Editar(Id, Puesto, Estatus) {
    $("#txtIdPuestoMEditar").val(Id);
    $("#txtPuestoMEditar").val(Puesto);
    if (Estatus == "Activo") {
    ...
    $("#txtPuestoMEditar").focus();
}

function EditarPuesto() {
    if (ValidarCamposEditar()) {
        var Id = parseInt($("#txtIdPuestoMEditar").val());
        var Puesto = $("#txtPuestoMEditar").val();
        ...
        $.ajax({
            url: '/Catalogos/Puesto/Editar',
            type: "POST",
            data: { Id, Puesto, Estatus }
        }).done(function (data, textStatus, jqXHR) {
            if (data.codigo === "Error") {
                resetToastPosition();
                $.toast({
